...
case 100...120:
    ...
    break
case 121...140:
    print("You are in the Light zone. Activity in this zone helps improve basic edurance and fat burning")
    break
case 141...160:
    print("You are in the Moderate zone. Activity in this zone helps improve aerobic fitness.")
    break
case 161...180:
    print("You are in the Hard zone. Activity in this zone increases maximum performance capacity for shorters sessions")
    break
case 181...200:
